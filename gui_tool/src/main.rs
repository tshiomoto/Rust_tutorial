...
use iced::{button, executor, Align, Application, Button, Column, Command, Element, Font, 
...
where H: std::hash::Hasher {
    ...
    fn stream(
        ...
        interval(self.duration).map(|_| Instant::now()).boxed()
    }
